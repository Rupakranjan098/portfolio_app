    ...
    <footer id="contact" class="footer container">
        <div class="footer-content">
            ...
            <div class="footer-links">
                ...
                <div class="link-group">
                    ...
                    <ul>
                        ...
                        @if($profile->linkedin_url) <li><a href="{{ $profile->linkedin_url }}">LinkedIn</a></li> @endif
                        @if($profile->github_url) <li><a href="{{ $profile->github_url }}">GitHub</a></li> @endif
                    </ul>
                </div>
            </div>
            <div class="footer-social">
                <h4>Let's Connect</h4>
                <div class="social-links">
                    @if($profile->linkedin_url) <a href="{{ $profile->linkedin_url }}"><i class="fa-brands fa-linkedin-in"></i></a> @endif
                    @if($profile->github_url) <a href="{{ $profile->github_url }}"><i class="fa-brands fa-github"></i></a> @endif
                    @if($profile->twitter_url) <a href="{{ $profile->twitter_url }}"><i class="fa-brands fa-twitter"></i></a> @endif
                    @if($profile->website_url) <a href="{{ $profile->website_url }}"><i class="fa-solid fa-globe"></i></a> @endif
                </div>
            </div>
        </div>
